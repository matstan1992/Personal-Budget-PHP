<?php
	...
	try {
		...
		if ($connection->connect_errno != 0) {
			...
			$_SESSION['heading'] = 'Bilans za poprzedni miesiąc ('.$date->format('01/m/Y').' - '.$date->format('t/m/Y').')';
